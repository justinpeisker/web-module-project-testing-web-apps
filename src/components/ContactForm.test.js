...
test('renders "email must be a valid email address" if an invalid email is entered', async () => {
    ...
    userEvent.type(emailField, "smith@gmail");
...
test('renders all firstName, lastName and email text when submitted. Does NOT render message if message is not submitted.', async () => {
    ...
    userEvent.type(firstNameField, "john");
    userEvent.type(lastNameField, "smith");
    userEvent.type(emailField, "smith@email.com");
    ...
    await waitFor(()=> {
        ...
        const emailDisplay = screen.queryByText("smith@email.com");
...
test('renders all fields text when all fields are submitted.', async () => {
    ...
    userEvent.type(firstNameField, "john");
    userEvent.type(lastNameField, "smith");
    userEvent.type(emailField, "smith@gmail.com");
    ...
    await waitFor(()=> {
        ...
        const emailDisplay = screen.queryByText(/smith@gmail.com/i);
